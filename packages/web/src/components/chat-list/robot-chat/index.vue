<template>
  <div class="flex gap-4 items-start not-first:mt-6">
...
const thinkingLabel = computed(() => props.robotSay.description?.trim() || 'Message received, processing...')

const platformKey = computed(() => (props.robotSay.platform ?? '').trim().toLowerCase())
</script>
